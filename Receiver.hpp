...
{
public:
    Receiver(std::shared_ptr<tcp::socket> socket,
...
private:
    void read()
    {
        ...
        boost::asio::async_read(*_socket,
                                ...
                                boost::bind(&Receiver::onReadHeader, this, boost::asio::placeholders::error,
    ...
    void onReadHeader(boost::system::error_code ec, size_t bytesTransferred)
    {
        ...
        boost::asio::async_read(*_socket,
                                ...
                                boost::bind(&Receiver::onReadData, this, boost::asio::placeholders::error,
                                            boost::asio::placeholders::bytes_transferred));
    }
